                ...
                {featuredProducts.map((product) => (
                  <Card key={product.id} className="overflow-hidden bg-white/50 border-primary/10 hover:border-primary/30 transition-all duration-500 group gold-border shadow-xl hover:shadow-2xl">
                    <div className="relative h-72 bg-muted flex items-center justify-center overflow-hidden">
                      ...
                      {product.featured && (
                        <div className="absolute top-4 right-4 bg-primary/90 text-primary-foreground px-4 py-1.5 rounded-full text-xs font-serif uppercase tracking-[0.2em] shadow-lg z-20">
                          Sanctified
                        </div>
                      )}
                    </div>
                    <CardHeader className="space-y-2">
                      ...
                      {product.benefits && (
                        <div className="text-xs font-serif italic text-primary/70 bg-primary/5 p-2 rounded border border-primary/10 line-clamp-1 mt-2">
                          ✨ {product.benefits}
                        </div>
                      )}
                    </CardHeader>
